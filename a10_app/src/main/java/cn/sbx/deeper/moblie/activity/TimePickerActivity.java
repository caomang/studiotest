...
import com.sunboxsoft.office.view.wheel.OnWheelChangedListener;
...
//        wheel_year.addChangingListener(listener);
     ...
     // month
      ...
      //day
        updateDays(wheel_year, wheel_month, wheel_day);
        wheel_day.setCurrentItem(calendar.get(Calendar.DAY_OF_MONTH) - 1);
	...
	public void onClick(View v) {
		...
		case R.id.bt_cheel_choose://选择
			...
			intent.putExtra("CHEEL_TIME", ((calendar.get(Calendar.YEAR)-10)+wheel_year.getCurrentItem()) + "-" + (((wheel_month.getCurrentItem()+1)<10)?"0"+(wheel_month.getCurrentItem()+1):(wheel_month.getCurrentItem()+1)) + "-" + ((wheel_day.getCurrentItem()+1)<10?"0"+(wheel_day.getCurrentItem()+1):(wheel_day.getCurrentItem()+1)));
