 ...
 * 
 */
public class TimePickerMonthActivity extends BaseActivity implements OnClickListener{
...
//		wheel_day = (WheelView) findViewById(R.id.wheel_day);
		...
		OnWheelChangedListener listener = new OnWheelChangedListener() {
            public void onChanged(WheelView wheel, int oldValue, int newValue) {
            	updateDays(wheel_year, wheel_month);
            }
        };
...
//        wheel_year.addChangingListener(listener);
	...
	public void onClick(View v) {
		...
		case R.id.bt_cheel_choose://选择
			...
			intent.putExtra("CHEEL_TIME", ((calendar.get(Calendar.YEAR)-10)+wheel_year.getCurrentItem()) + "-" + (((wheel_month.getCurrentItem()+1)<10)?"0"+(wheel_month.getCurrentItem()+1):(wheel_month.getCurrentItem()+1)));
