...
public class WritePadDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.handwriting_dialog_main);
 ...
 int height = wm.getDefaultDisplay().getHeight();
		...
		p.height = (int) (height*0.8);//(int) (d.getHeight() * 0.4);   //�߶�����Ϊ��Ļ��0.4 
		p.width = (int) (width*0.8);//(int) (d.getWidth() * 0.6);    //�������Ϊ��Ļ��0.6		   
...
//					Ȼ��رյ�ǽactivity
					((HandwritingActivity) context).finish();
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
