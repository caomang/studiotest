...
public class MyListView extends ListView implements OnScrollListener {
	...
	private LinearLayout headView;// 头列表视图
	private TextView tipsTextview;// 操作提示文字框
	private TextView lastUpdatedTextView;// 最后更新时间文字框
	private ImageView arrowImageView;// 箭头图片
	private ProgressBar progressBar;// 加载控件
	private RotateAnimation animation;// 箭头动画
	private RotateAnimation reverseAnimation;// 箭头翻转动画

	// 用于保证startY的值在一个完整的touch事件中只被记录一次
	private boolean isRecored;
	private int startY;
	private int firstItemIndex;
	private int headContentHeight;// 头列表的高度
	private int state;
	...
	private void init(Context context) {
		...
		progressBar = (ProgressBar) headView.findViewById(R.id.bar_progress);
		tipsTextview = (TextView) headView.findViewById(R.id.text_tips);
		lastUpdatedTextView = (TextView) headView
				.findViewById(R.id.text_last_update);
		arrowImageView = (ImageView) headView.findViewById(R.id.ic_arrow);
